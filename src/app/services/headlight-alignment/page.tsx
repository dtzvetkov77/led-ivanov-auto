...
export default async function HeadlightAlignmentPage() {
  ...
  return (
    <div className="bg-background min-h-screen text-white">
      ...
      {/* ── Hero ── */}
      <section className="relative md:min-h-[60vh] flex flex-col items-center justify-center overflow-hidden">
      ...
      {gallery.length > 0 && (
        <div className="max-w-5xl mx-auto px-4 pt-8 pb-8">
          ...
          <LightboxGallery images={gallery} alt="Регулиране на фарове" />
        </div>
      )}
