    ...
    <div className="max-w-7xl mx-auto px-4 py-8">
      ...
      {activeFiltersCount === 0 && (
        <p className="text-muted text-sm leading-relaxed mb-5 max-w-3xl">
          Открийте нашия пълен каталог от <strong className="text-white">LED и ксенон крушки за автомобили</strong> — халогени H1, H4, H7, H8, H9, H11, D1S, D2S и много други. Всички крушки са с Plug &amp; Play монтаж, без CanBus грешки и до 2 год. гаранция. Доставяме с Еконт и Спиди до цяла България.
        </p>
      )}
