...
const FAQ = [
  ...
  },
  {
    ...
    a: 'Да – при поръчка над 199 € доставката е напълно безплатна. При по-малки поръчки куриерската такса е стандартна според тарифата на избрания куриер.',
  },
  {
