  ...
  '@graph': [
    {
      ...
      description: 'LED и ксенон крушки за фарове, полиране, фолиране и регулиране на фарове в София. Plug & Play монтаж, до 2 год. гаранция.',
      url: SITE,
    ...
    <html lang="bg">
      <body className={`${inter.variable} ${oswald.variable} font-sans bg-background text-white`}>
        ...
        <div className="fixed top-0 left-0 right-0 z-50 bg-accent text-white text-xs h-8 flex items-center justify-center font-semibold tracking-widest uppercase gap-3 sm:gap-6">
          {/* Phone */}
          <a href="tel:+359999997996" className="flex items-center gap-1.5 hover:opacity-80 transition-opacity">
          ...
          <span className="flex items-center gap-1.5">
            ...
            <span className="hidden sm:inline">Доставка за 1–2 работни дни</span>
            <span className="sm:hidden">Доставка за 1–2 дни</span>
          </span>
        </div>
        <Navbar />
