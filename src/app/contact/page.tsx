...
const FAQ = [
  {
    ...
    a: 'Да! Всеки продукт закупен от нашия магазин е с минимум 2 години гаранция. За серия D предлагаме 4 години гаранция. При дефект – подменяме без въпроси.',
  },
  {
    q: 'Колко дни са нужни за доставка?',
    a: 'Стандартната доставка е в рамките на 1–2 работни дни. При поръчка до 14:00 ч., изпращаме същия ден.',
  },
  {
